...
生成时间分析引擎针对有问题的代码模式向开发人员发出警告，以检测所需的其他代码。 可使用属性批注代码，以告知裁边器要包含的其他内容。 使用[源生成器](https://github.com/dotnet/roslyn/blob/master/docs/features/source-generators.md)可将许多反射模式替换为生成时代码生成。
