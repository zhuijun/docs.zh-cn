...
## <a name="completing-the-requirements"></a><span data-ttu-id="3e2af-153">完成要求</span><span class="sxs-lookup"><span data-stu-id="3e2af-153">Completing the requirements</span></span>
