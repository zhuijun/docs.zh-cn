---
title: UI 自动化概述
description: 阅读 Microsoft UI 自动化的概述，它是支持 Windows Presentation Foundation （WPF）的 Windows 操作系统的可访问性框架。
ms.date: 03/30/2017
helpviewer_keywords:
...
|UIAutomationClientsideProviders.dll|一组用于标准旧版本控件的 UI 自动化提供程序。 （ [!INCLUDE[TLA2#tla_winclient](../../../includes/tla2sharptla-winclient-md.md)] 控件具有对的本机支持 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] 。）此支持自动提供给客户端应用程序。|  
