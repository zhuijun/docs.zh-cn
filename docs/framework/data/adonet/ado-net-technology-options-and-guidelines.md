...
### <a name="linq-to-entities"></a>LINQ to Entities  
 LINQ to Entities 是一种语言集成查询（LINQ）实现，它允许开发人员通过使用 LINQ 表达式和 LINQ 标准查询运算符对实体框架对象上下文创建强类型查询。 LINQ to Entities 允许开发人员使用跨 Microsoft SQL Server 和第三方数据库的灵活对象关系映射来处理概念模型。 有关详细信息，请参阅[LINQ to Entities](./ef/language-reference/linq-to-entities.md)。  
