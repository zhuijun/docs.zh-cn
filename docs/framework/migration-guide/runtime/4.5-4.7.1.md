...
author: chlowell
ms.openlocfilehash: c9da47d7f4643cf6279ea1e7efb01f7774606224
ms.sourcegitcommit: 97405ed212f69b0a32faa66a5d5fae7e76628b68
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/01/2020
ms.locfileid: "91608002"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-471"></a><span data-ttu-id="d43ae-103">针对 .NET Framework 4.5 到 4.7.1 迁移的运行时更改</span><span class="sxs-lookup"><span data-stu-id="d43ae-103">Runtime Changes for Migration from .NET Framework 4.5 to 4.7.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="d43ae-104">如果要从 .NET Framework 4.5 迁移到 4.7.1，请在以下主题中查看可能影响你的应用的应用程序兼容性问题：</span><span class="sxs-lookup"><span data-stu-id="d43ae-104">If you are migrating from the .NET Framework 4.5 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="d43ae-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="d43ae-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="d43ae-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="d43ae-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="d43ae-107">核心</span><span class="sxs-lookup"><span data-stu-id="d43ae-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="d43ae-108">数据</span><span class="sxs-lookup"><span data-stu-id="d43ae-108">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="d43ae-109">调试器</span><span class="sxs-lookup"><span data-stu-id="d43ae-109">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="d43ae-110">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="d43ae-110">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="d43ae-111">全球化</span><span class="sxs-lookup"><span data-stu-id="d43ae-111">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="d43ae-112">网络</span><span class="sxs-lookup"><span data-stu-id="d43ae-112">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="d43ae-113">安全性</span><span class="sxs-lookup"><span data-stu-id="d43ae-113">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="d43ae-114">序列化</span><span class="sxs-lookup"><span data-stu-id="d43ae-114">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="d43ae-115">安装和部署</span><span class="sxs-lookup"><span data-stu-id="d43ae-115">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="d43ae-116">工具</span><span class="sxs-lookup"><span data-stu-id="d43ae-116">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="d43ae-117">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="d43ae-117">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="d43ae-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="d43ae-118">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="d43ae-119">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="d43ae-119">Windows Workflow Foundation (WF)</span></span>
