...
author: chlowell
ms.openlocfilehash: b7dfb9f0e503ae8e795e6deacf456bca87c5b9dc
ms.sourcegitcommit: 97405ed212f69b0a32faa66a5d5fae7e76628b68
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/01/2020
ms.locfileid: "91609533"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-46"></a><span data-ttu-id="7030f-103">针对 .NET Framework 4.5 到 4.6 迁移的运行时更改</span><span class="sxs-lookup"><span data-stu-id="7030f-103">Runtime Changes for Migration from .NET Framework 4.5 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="7030f-104">如果要从 .NET Framework 4.5 迁移到 4.6，请在以下主题中查看可能影响你的应用的应用程序兼容性问题：</span><span class="sxs-lookup"><span data-stu-id="7030f-104">If you are migrating from the .NET Framework 4.5 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="7030f-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="7030f-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="7030f-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="7030f-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="7030f-107">核心</span><span class="sxs-lookup"><span data-stu-id="7030f-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="7030f-108">数据</span><span class="sxs-lookup"><span data-stu-id="7030f-108">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="7030f-109">调试器</span><span class="sxs-lookup"><span data-stu-id="7030f-109">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="7030f-110">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="7030f-110">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="7030f-111">网络</span><span class="sxs-lookup"><span data-stu-id="7030f-111">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="7030f-112">序列化</span><span class="sxs-lookup"><span data-stu-id="7030f-112">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="7030f-113">安装和部署</span><span class="sxs-lookup"><span data-stu-id="7030f-113">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="7030f-114">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="7030f-114">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="7030f-115">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="7030f-115">Windows Presentation Foundation (WPF)</span></span>
