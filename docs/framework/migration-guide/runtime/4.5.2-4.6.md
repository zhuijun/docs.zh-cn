...
description: 在从 .NET Framework 4.5.2 迁移到 4.6 时，查找有关运行时更改导致的应用程序兼容性问题的信息，这些问题可能会影响你的应用。
ms.date: 07/10/2019
ms.assetid: 18cae806-020b-4db5-8113-e09ae6bbc06a
author: chlowell
ms.openlocfilehash: 17a5a939bc25ce7f82e2ba324257499dc7d9cb9a
ms.sourcegitcommit: 2543a78be6e246aa010a01decf58889de53d1636
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/17/2020
ms.locfileid: "86442163"
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-46"></a><span data-ttu-id="90f67-103">针对 .NET Framework 4.5.2 到 4.6 迁移的运行时更改</span><span class="sxs-lookup"><span data-stu-id="90f67-103">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="90f67-104">如果要从 .NET Framework 4.5.2 迁移到 4.6，请在以下主题中查看可能影响你的应用的应用程序兼容性问题：</span><span class="sxs-lookup"><span data-stu-id="90f67-104">If you are migrating from the .NET Framework 4.5.2 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="90f67-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="90f67-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="90f67-106">核心</span><span class="sxs-lookup"><span data-stu-id="90f67-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="90f67-107">数据</span><span class="sxs-lookup"><span data-stu-id="90f67-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="90f67-108">调试器</span><span class="sxs-lookup"><span data-stu-id="90f67-108">Debugger</span></span>
...
## <a name="networking"></a><span data-ttu-id="90f67-109">网络</span><span class="sxs-lookup"><span data-stu-id="90f67-109">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="90f67-110">序列化</span><span class="sxs-lookup"><span data-stu-id="90f67-110">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="90f67-111">安装和部署</span><span class="sxs-lookup"><span data-stu-id="90f67-111">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="90f67-112">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="90f67-112">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="90f67-113">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="90f67-113">Windows Presentation Foundation (WPF)</span></span>
