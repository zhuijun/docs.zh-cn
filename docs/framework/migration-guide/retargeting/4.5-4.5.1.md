...
---
# <a name="retargeting-changes-for-migration-from-net-framework-45-to-451"></a><span data-ttu-id="20d83-103">针对 .NET Framework 4.5 到 4.5.1 迁移的重定向更改</span><span class="sxs-lookup"><span data-stu-id="20d83-103">Retargeting Changes for Migration from .NET Framework 4.5 to 4.5.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="20d83-104">如果要从 .NET Framework 4.5 迁移到 4.5.1，请在以下主题中查看可能影响你的应用的应用程序兼容性问题：</span><span class="sxs-lookup"><span data-stu-id="20d83-104">If you are migrating from the .NET Framework 4.5 to 4.5.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="20d83-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="20d83-105">ADO.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="20d83-106">核心</span><span class="sxs-lookup"><span data-stu-id="20d83-106">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="20d83-107">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="20d83-107">Entity Framework</span></span>
...
## <a name="msbuild"></a><span data-ttu-id="20d83-108">MSBuild</span><span class="sxs-lookup"><span data-stu-id="20d83-108">MSBuild</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="20d83-109">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="20d83-109">Windows Presentation Foundation (WPF)</span></span>
