...
> [!IMPORTANT]
> 为了使 Windows 应用商店应用程序进行跨计算机调用，你必须启用另一个名为 "家庭/工作网络" 的功能。 此设置也位于 "功能" 选项卡下的 appmanifest 文件中。选中 "家庭/工作网络" 复选框。 这样，应用程序就可以入站和出站访问用户的受信任位置（例如家庭和工作）的网络。 将始终阻止关键入站端口。 为了访问 Internet 上的服务，您还必须启用“Internet (客户端}”功能。  
