...
|WS 元数据交换|[Web 服务元数据交换 (WS-MetadataExchange) 1.1 版](https://specs.xmlsoap.org/ws/2004/09/mex/WS-MetadataExchange.pdf)<br /><br /> WCF 实现 Ws-metadataexchange 来检索 XML 架构、WSDL 和 WS 策略。|  
