...
|AnonymousForCertificate|无|X509|Message|  
|UserNameForCertificate|用户名/密码|X509|Message|  
|MutualCertificate|X509|X509|Message|  
|MutualCertificateDuplex|X509|X509|Message|  
|IssuedTokenForCertificate|联合|X509|Message|  
|Kerberos|Windows|Windows|Message|  
|IssuedToken|联合|联合|Message|  
|SspiNegotiated|协商的 Windows Sspi|协商的 Windows Sspi|Message|  
|AnonymousForSslNegotiated|无|X509、TLS-Nego|Message|  
|UserNameForSslNegotiated|用户名/密码|X509、TLS-Nego|Message|  
|MutualSslNegotiated|X509|X509、TLS-Nego|Message|  
|IssuedTokenForSslNegotiated|联合|X509、TLS-Nego|Message|  
