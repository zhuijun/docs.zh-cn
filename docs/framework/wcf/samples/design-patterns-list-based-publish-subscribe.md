...
1. 安装服务计算机：  
    ...
    1. 在服务计算机上创建一个名为 ServiceModelSamples 的虚拟目录。 [Windows Communication Foundation 示例的一次性安装过程](one-time-setup-procedure-for-the-wcf-samples.md)中的批处理文件 setupvroot.bat 可用于创建磁盘目录和虚拟目录。  
