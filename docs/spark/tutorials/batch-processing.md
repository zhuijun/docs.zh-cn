...
1. <span data-ttu-id="5b63d-160">使用以下命令来构建 .NET 应用：</span><span class="sxs-lookup"><span data-stu-id="5b63d-160">Use the following command to build your .NET app:</span></span>
