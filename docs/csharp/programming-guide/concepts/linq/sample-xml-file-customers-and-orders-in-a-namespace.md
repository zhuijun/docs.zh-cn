...
---
# <a name="sample-xml-file-customers-and-orders-in-a-namespace"></a><span data-ttu-id="34bdc-105">示例 XML 文件：命名空间中的客户和订单</span><span class="sxs-lookup"><span data-stu-id="34bdc-105">Sample XML File: Customers and Orders in a Namespace</span></span>
<span data-ttu-id="34bdc-106">下面的 XML 文件用在 [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] 文档的很多示例中。</span><span class="sxs-lookup"><span data-stu-id="34bdc-106">The following XML file is used in various examples in the [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] documentation.</span></span> <span data-ttu-id="34bdc-107">此文件包含客户和订单。</span><span class="sxs-lookup"><span data-stu-id="34bdc-107">This file contains customers and orders.</span></span> <span data-ttu-id="34bdc-108">该 XML 在某个命名空间中。</span><span class="sxs-lookup"><span data-stu-id="34bdc-108">The XML is in a namespace.</span></span>  
  
## <a name="customersordersinnamespacexml"></a><span data-ttu-id="34bdc-109">CustomersOrdersInNamespace.xml</span><span class="sxs-lookup"><span data-stu-id="34bdc-109">CustomersOrdersInNamespace.xml</span></span>  
