...
## <a name="on-error-goto--1"></a><span data-ttu-id="4f441-158">Error GoTo 时-1</span><span class="sxs-lookup"><span data-stu-id="4f441-158">On Error GoTo -1</span></span>
