...
许多文件系统操作实质上是查询，因此非常适合使用 LINQ 方法。  
 ...
 [如何：按扩展名对文件分组（LINQ）（Visual Basic）](how-to-group-files-by-extension-linq.md)  
 ...
 [如何：比较两个文件夹的内容（LINQ）（Visual Basic）](how-to-compare-the-contents-of-two-folders-linq.md)  
