...
ms.locfileid: "84413331"
---
# <a name="sample-xml-file-customers-and-orders-in-a-namespace"></a><span data-ttu-id="6c221-102">示例 XML 文件：命名空间中的客户和订单</span><span class="sxs-lookup"><span data-stu-id="6c221-102">Sample XML File: Customers and Orders in a Namespace</span></span>
<span data-ttu-id="6c221-103">下面的 XML 文件用在 [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] 文档的很多示例中。</span><span class="sxs-lookup"><span data-stu-id="6c221-103">The following XML file is used in various examples in the [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] documentation.</span></span> <span data-ttu-id="6c221-104">此文件包含客户和订单。</span><span class="sxs-lookup"><span data-stu-id="6c221-104">This file contains customers and orders.</span></span> <span data-ttu-id="6c221-105">该 XML 在某个命名空间中。</span><span class="sxs-lookup"><span data-stu-id="6c221-105">The XML is in a namespace.</span></span>  
  
## <a name="customersordersinnamespacexml"></a><span data-ttu-id="6c221-106">CustomersOrdersInNamespace.xml</span><span class="sxs-lookup"><span data-stu-id="6c221-106">CustomersOrdersInNamespace.xml</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="6c221-107">另请参阅</span><span class="sxs-lookup"><span data-stu-id="6c221-107">See also</span></span>

- [<span data-ttu-id="6c221-108">示例 XML 文档 (LINQ to XML)</span><span class="sxs-lookup"><span data-stu-id="6c221-108">Sample XML Documents (LINQ to XML)</span></span>](sample-xml-documents-linq-to-xml.md)
