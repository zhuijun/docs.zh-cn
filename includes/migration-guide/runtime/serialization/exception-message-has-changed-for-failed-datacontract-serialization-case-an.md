...
---
### <a name="exception-message-has-changed-for-failed-datacontract-serialization-in-case-of-an-unknown-type"></a><span data-ttu-id="92677-101">在未知类型的情况下，DataContract 序列化失败的异常消息已更改</span><span class="sxs-lookup"><span data-stu-id="92677-101">Exception message has changed for failed DataContract serialization in case of an unknown type</span></span>

#### <a name="details"></a><span data-ttu-id="92677-102">详细信息</span><span class="sxs-lookup"><span data-stu-id="92677-102">Details</span></span>

<span data-ttu-id="92677-103">从 .NET Framework 4.6 开始，如果 <xref:System.Runtime.Serialization.DataContractSerializer?displayProperty=fullName> 或 <xref:System.Runtime.Serialization.Json.DataContractJsonSerializer?displayProperty=fullName> 由于缺少已阐明的“已知类型”而无法序列化或反序列化，则会发出异常消息。</span><span class="sxs-lookup"><span data-stu-id="92677-103">Beginning in the .NET Framework 4.6, the exception message given if a <xref:System.Runtime.Serialization.DataContractSerializer?displayProperty=fullName> or <xref:System.Runtime.Serialization.Json.DataContractJsonSerializer?displayProperty=fullName> fails to serialize or deserialize due to missing 'known types' has been clarified.</span></span>

#### <a name="suggestion"></a><span data-ttu-id="92677-104">建议</span><span class="sxs-lookup"><span data-stu-id="92677-104">Suggestion</span></span>

<span data-ttu-id="92677-105">应用不应依赖于特定异常消息。</span><span class="sxs-lookup"><span data-stu-id="92677-105">Apps should not depend on specific exception messages.</span></span> <span data-ttu-id="92677-106">如果应用依赖于此消息，可选择更新应用以期得到新消息或（最好）将其更改为仅依赖异常类型。</span><span class="sxs-lookup"><span data-stu-id="92677-106">If an app depends on this message, either update it to expect the new message or (preferably) change it to depend only on the exception type.</span></span>

| <span data-ttu-id="92677-107">名称</span><span class="sxs-lookup"><span data-stu-id="92677-107">Name</span></span>    | <span data-ttu-id="92677-108">值</span><span class="sxs-lookup"><span data-stu-id="92677-108">Value</span></span>       |
|:--------|:------------|
| <span data-ttu-id="92677-109">范围</span><span class="sxs-lookup"><span data-stu-id="92677-109">Scope</span></span>   |<span data-ttu-id="92677-110">边缘</span><span class="sxs-lookup"><span data-stu-id="92677-110">Edge</span></span>|
|<span data-ttu-id="92677-111">Version</span><span class="sxs-lookup"><span data-stu-id="92677-111">Version</span></span>|<span data-ttu-id="92677-112">4.6</span><span class="sxs-lookup"><span data-stu-id="92677-112">4.6</span></span>|
|<span data-ttu-id="92677-113">类型</span><span class="sxs-lookup"><span data-stu-id="92677-113">Type</span></span>|<span data-ttu-id="92677-114">运行时</span><span class="sxs-lookup"><span data-stu-id="92677-114">Runtime</span></span>|

#### <a name="affected-apis"></a><span data-ttu-id="92677-115">受影响的 API</span><span class="sxs-lookup"><span data-stu-id="92677-115">Affected APIs</span></span>
